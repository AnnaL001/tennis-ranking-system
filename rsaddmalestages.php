...
<!DOCTYPE html>
    ...
    <body>
         ...
         if ($_SESSION['user_type'] == 'Super admin'){
            ...
            //Inserting data
               ...
               $sql="INSERT INTO malestages(stage_name,tournamentID) VALUES('$stagename','$tournamentId')";
               if($conn->query($sql)) {
                       ?>
                        <center>
  ...
  <br><br>   
		...
		<form action="rsaddmalestages.php" method="POST">
			<?php    
        if ($_SESSION['user_type'] == 'Super admin'){
			?>
			     <div class="card card-container">
              <p id="profile-name" class="profile-name-card" style="font-size:18px;">Add male stages
              </p>
  ...
  <option value = "<?php print $tournament_res_row["tournamentID"]; ?>"><?php echo $tournament_res_row["tournament_name"];?></option>
  <?php } ?>
</select><br>
                   
                   <input class="btn btn-lg btn-primary btn-block btn-signin" type="submit" name="add_male_stage" style="width:269px; height:40px;color:white;font-size:16px" value="Add stage">
