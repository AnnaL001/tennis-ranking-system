...
<!DOCTYPE html>
    ...
    <body>
         ...
         if ($_SESSION['user_type'] == 'Super admin'){
            //Super Admin has the ability for adding categories
              if(isset($_POST["add_male_tournament"])){
            ...
            //Inserting data
               ...
               $sql="INSERT INTO maletournaments(tournament_name,tournament_strength,destination,categoryId) VALUES('$tournamentname','$tournamentstrength','$destination','$categoryId')";
               if($conn->query($sql)) {
                       ?>
                        <center>
  ...
  <br><br>   
		...
		<form action="rsaddmaletournaments.php" method="POST">
			<?php    
        if ($_SESSION['user_type'] == 'Super admin'){
			?>
			     <div class="card card-container">
              <p id="profile-name" class="profile-name-card" style="font-size:18px;">Add male tournament
              </p>
  ...
  <?php } ?>
                  ...
                  <input class="btn btn-lg btn-primary btn-block btn-signin" type="submit" name="add_male_tournament" style="width:269px; height:40px;color:white;font-size:16px" value="Add male tournament">
