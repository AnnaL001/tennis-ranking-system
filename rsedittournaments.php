...
<body>
    ...
    <!--  content -->
           ...
           <?php
            $tournid = $_GET['id'];
            if (isset($tournid)){
                            $sql = "SELECT * FROM tournament WHERE tournamentId='$tournid'";
                         ...
                         <!-- Update User -->
                            ...
                            <?php
                              ...
                              if (isset($_POST['edit_tournament'])) {
                                ...
                                //Inserting data
                                $sql="UPDATE tournament SET tournamentName='$tournamentname',tournamentStrength='$tournamentstrength',destination='$destination', categoryId='$categoryId' WHERE tournamentId='$tournid'";
            ...
            <p id="profile-name" class="profile-name-card" style="font-size:18px;">Edit tournament</p>
            ...
            Tournament<br>                                          
            <input type="text" name="tournamentname" id="inputEmail" class="form-control" placeholder="Tournament name" value="<?php echo $row['tournamentName']; ?>">
            Tournament strength<br>
             <input type="number" name="tournamentstrength" id="inputEmail" class="form-control" placeholder="Tournament strength" value="<?php echo $row['tournamentStrength']; ?>">
             Destination<br>
  ...
  <?php } ?>
            ...
            <input class="btn btn-lg btn-primary btn-block btn-signin" type="submit" name="edit_tournament" style="width:269px; height:40px;color:white;font-size:16px" value="Edit tournament">
