...
<!DOCTYPE html>
  ...
  <br><br>   
		...
		<form action="rsaddcategory.php" method="POST">
			<?php    
        if ($_SESSION['user_type'] == 'Super admin'){
			?>
			     <div class="card card-container">
              <p id="profile-name" class="profile-name-card" style="font-size:18px;">Add category
              </p>
         ...
         ?>
              ...
              <form class="form-signin" method="POST">
                  ...
                  Category<br>
                   <input type="text" name="categoryname" id="inputEmail" class="form-control" required><br>
                  
                  <input class="btn btn-lg btn-primary btn-block btn-signin" type="submit" name="add_category" style="width:269px; height:40px;color:white;font-size:16px" value="Add category">
